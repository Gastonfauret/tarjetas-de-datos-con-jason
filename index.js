...
//Anadimos un escuchador del evento "load", la carga de la pagina.
...
const cardTemplate = document.getElementById('card-template');
    ...
    card.querySelector('.card-title').textContent = dato.nombre; //textContent: Modifica el contenido del texto.
